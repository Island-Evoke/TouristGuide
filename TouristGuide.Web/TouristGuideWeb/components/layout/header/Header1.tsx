				...
				<div className="top-bar">
					<div className="container-fluid">
						<div className="text-header">
							<div className="text-unlock text-sm-bold"></div><Link className="link-secondary-2" href="#">
				...
				<div className="container-fluid background-body">
					<div className="main-header">
						<div className="header-left">
							{/* <div className="header-logo"><Link className="d-flex" href="/"><img className="light-mode" alt="" src="/assets/imgs/template/logo.svg" /><img className="dark-mode" alt="" src="/assets/imgs/template/logo-w.svg" /></Link></div> */}
