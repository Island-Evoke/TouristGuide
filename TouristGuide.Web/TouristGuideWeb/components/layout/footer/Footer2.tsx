                ...
                <div className="container">
                    <div className="row">
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm-6">
                                    <ul className="menu-footer">
                                        ...
                                        <li><Link href="#">Travel plane</Link></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-4 mb-30">
                            ...
                            <p className="neutral-500 text-xs-medium">No ads. No trails. No commitments</p>
                        </div>
                    </div>
                    ...
                    <div className="footer-bottom">
                        <div className="row align-items-center">
                            <div className="col-md-6 text-md-start text-center mb-20">
                                <p className="text-sm neutral-500">© {new Date().getFullYear()} Cylonian inn Inc. All rights reserved.</p>
                            </div>
