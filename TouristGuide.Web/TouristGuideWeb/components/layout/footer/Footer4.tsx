...
export default function Footer4() {
    return (
        <>
            <footer className="footer footer-type-6">
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-3 mt-30">
                            <p className="text-lg neutral-0 mb-15">Newsletter</p>
                            <div className="d-flex align-items-center">
                                <form className="form-newsletter form-newsletter-2" action="#">
                                    <input className="form-control" type="text" placeholder="Enter your email" />
                                    <input className="btn btn-brand-secondary w-100 justify-content-center" type="submit" defaultValue="Subscribe" />
                                </form>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row align-items-center">
                            ...
                            <div className="col-md-6 text-md-end text-center mb-20">
                                <div className="d-flex align-items-center justify-content-center justify-content-md-end box-socials-footer-cover">
                                    <p className="text-lg-bold color-white d-inline-block mr-10">Follow us</p>
