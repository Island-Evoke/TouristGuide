					...
					<section className="box-section box-breadcrumb background-100">
						<div className="container">
							<ul className="breadcrumbs">
								...
								<li> <span className="text-breadcrumb">About Us</span></li>
							</ul>
						</div>
					</section>
							...
							<div className="row align-items-end">
								<div className="col-lg-7 wow fadeInUp"> <span className="btn btn-brand-secondary"> <img className="mr-10" src="/assets/imgs/page/homepage9/real.svg" alt="Travile" />Resort Real Estate</span>
									<h1 className="neutral-1000 mt-15 mb-15">
										Welcome<span>to  </span>Travel  <span>booking system</span></h1>
								...
								<div className="col-lg-6 mb-30"><span className="btn btn-brand-secondary background-0 wow fadeInUp"> <img className="mr-10" src="/assets/imgs/page/homepage4/earth.svg" alt="Travile" />Why book at Cylonian inn ?</span>
									...
									<div className="list-numbers wow fadeInUp">
										<div className="item-number">
											...
											<p className="text-lg-bold neutral-500">Global Branches</p>
										</div>
										<div className="item-number">
											<h3 className="neutral-1000">29K</h3>
											<p className="text-lg-bold neutral-500">Destinations Collaboration</p>
										</div>
										<div className="item-number">
								...
								<div className="row">
									<div className="col-lg-4 col-md-6 wow fadeInUp">
										<div className="card-team card-team-2">
											<div className="card-image"> <img src="/assets/imgs/page/pages/team6.png" alt="Travila" /></div>
											<div className="card-info">
												...
												<div className="card-team-bottom">
													<div className="card-socials"> <Link className="link-social background-100" href="#">
														...
														</svg></Link><Link className="link-social background-100" href="#">
															<svg width={15} height={15} viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">
													...
													<div className="card-button"> <Link href="/contact">
														<svg width={8} height={8} viewBox="0 0 8 8" xmlns="http://www.w3.org/2000/svg">
															<path d="M7.08848 6.97917L7.08848 1.20442L1.31373 1.20442M7.08848 1.20442L1.31373 6.97917" strokeLinecap="round" strokeLinejoin="round" />
														</svg></Link></div>
												</div>
											</div>
										</div>
									...
									<div className="col-lg-4 col-md-6 wow fadeInUp">
										<div className="card-team card-team-2">
											<div className="card-image"> <img src="/assets/imgs/page/pages/team.png" alt="Travila" /></div>
											<div className="card-info">
									...
									<div className="col-lg-4 col-md-6 wow fadeInUp">
										<div className="card-team card-team-2">
											<div className="card-image"> <img src="/assets/imgs/page/pages/team2.png" alt="Travila" /></div>
											<div className="card-info">
									...
									<div className="col-lg-4 col-md-6 wow fadeInUp">
										<div className="card-team card-team-2">
											<div className="card-image"> <img src="/assets/imgs/page/pages/team3.png" alt="Travila" /></div>
											<div className="card-info">
									...
									<div className="col-lg-4 col-md-6 wow fadeInUp">
										<div className="card-team card-team-2">
											<div className="card-image"> <img src="/assets/imgs/page/pages/team4.png" alt="Travila" /></div>
											<div className="card-info">
									...
									<div className="col-lg-4 col-md-6 wow fadeInUp">
										<div className="card-team card-team-2">
											<div className="card-image"> <img src="/assets/imgs/page/pages/team5.png" alt="Travila" /></div>
											<div className="card-info">
						...
						<div className="container">
							<div className="row align-items-center">
								...
								<div className="col-lg-7 mb-30">
									<div className="box-left-payment"><span className="btn btn-tag btn-brand-secondary">Easy payment</span>
