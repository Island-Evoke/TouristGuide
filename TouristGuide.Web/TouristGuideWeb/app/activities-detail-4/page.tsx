                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-8">
                                    ...
                                    <div className="box-banner-activities-detail-4"> <img src="/assets/imgs/page/activities/banner5.png" alt="Travile" />
                                        <div className="container-banner-activities">
                                            <div className="box-button-abs box-button-abs-right"> <Link className="btn btn-brand-secondary" href="#">
												...
												<VideoPopup vdocls="btn-play popup-youtube" style4 />
