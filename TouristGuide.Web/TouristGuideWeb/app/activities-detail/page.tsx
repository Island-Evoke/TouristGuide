							...
							<div className="container-banner-activities">
								<div className="box-banner-activities">
									<Slider {...settingsMain} ref={slider1} className="banner-activities-detail">
										<div className="banner-slide-activity"><img src="/assets/imgs/page/activities/banner.png" alt="Travila" /></div>
										<div className="banner-slide-activity"><img src="/assets/imgs/page/activities/banner.png" alt="Travila" /></div>
										<div className="banner-slide-activity"><img src="/assets/imgs/page/activities/banner.png" alt="Travila" /></div>
										<div className="banner-slide-activity"><img src="/assets/imgs/page/activities/banner.png" alt="Travila" /></div>
										<div className="banner-slide-activity"><img src="/assets/imgs/page/activities/banner.png" alt="Travila" /></div>
								...
								<div className="row">
									<div className="col-lg-8">
										<div className="tour-title-main">
											<h4 className="neutral-1000">Peak Pursuits: Adventuring Through Discovery Mountain's Hidden Gems</h4>
										</div>
									</div>
								</div>
