                            ...
                            <div className="box-banner-tour-detail-4-inner">
                                <div className="box-swiper">
                                    <div className="swiper-container swiper-group-1">
                                        <Swiper {...swiperGroup1}>
                                            <SwiperSlide>
                                                <div className="box-banner-tour-4"><img src="/assets/imgs/page/activities/banner-activities-5.png" alt="Travile" /></div>
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <div className="box-banner-tour-4"><img src="/assets/imgs/page/activities/banner-activities-5.png" alt="Travile" /></div>
                                            </SwiperSlide>
                        ...
                        <div className="box-header-on-top">
                            <div className="container">
                                <div className="tour-header tour-header-on-top">
                                    ...
                                    <div className="tour-title-main w-lg-75">
                                        <h4 className="color-white">The High Roller Experience: Tickets for The LINQ Observation Wheel, Las Vegas Strip</h4>
                                    </div>
                            ...
                            <div className="row">
                                <div className="col-lg-8">
                                    ...
                                    <div className="box-collapse-expand">
                                        ...
                                        <div className="group-collapse-expand">
                                            <button className="btn btn-collapse" type="button" data-bs-toggle="collapse" data-bs-target="#collapseMap" aria-expanded="false" aria-controls="collapseMap">
                                                <h6>Tour Map</h6>
                                                <svg width={12} height={7} viewBox="0 0 12 7" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 1L6 6L11 1" stroke="" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
                                                </svg>
