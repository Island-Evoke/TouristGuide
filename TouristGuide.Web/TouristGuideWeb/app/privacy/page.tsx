                    ...
                    <section className="box-section box-breadcrumb background-100">
                        <div className="container">
                            <ul className="breadcrumbs">
                                ...
                                <li> <span className="text-breadcrumb">Terms Of Service</span></li>
                            </ul>
                        </div>
                    </section>
                        ...
                        <div className="container">
                            <div className="box-mw-824">
                                <div className="text-center">
                                    ...
                                    <p className="text-xl-medium neutral-1000 mb-55 wow fadeInUp">Last update: Mar 17, 2024</p>
                                </div>
                            </div>
                            ...
                            <div className="box-mw-824">
                                <div className="box-detail-info">
                                    <p>At Travila, we take your privacy seriously and are committed to  protecting your personal information. This Privacy Policy outlines how  we collect, use, disclose, and safeguard your data when you use our  website or services.</p>
                                    ...
                                    <p> <strong>Data Security: </strong>We implement security measures to protect your information from unauthorized access, disclosure, alteration, or destruction.</p>
                                    <p> <strong>Cookies: </strong>We may use cookies and similar technologies to enhance your browsing  experience, analyze website traffic, and personalize content and  advertisements.</p>
                                    ...
                                    <p>If you have any questions or concerns about our Privacy Policy or the  handling of your personal information, please contact us at contact@travila.com.</p>
