        ...
        <>
            ...
            <Layout headerStyle={1} footerStyle={1}>
                <main className="main">
                    ...
                    <section className="box-section block-banner-tour-detail-5 background-card">
                        <div className="box-banner-tour-detail-5">
                            <div className="box-banner-tour-detail-5-inner">
                                <div className="box-swiper">
                                    <div className="swiper-container swiper-center">
                                        <Swiper {...swiperCenterSlider}>
                                            <SwiperSlide>
                                                <div className="box-banner-tour-4"><img src="/assets/imgs/page/tour-detail/banner-detail-3.png" alt="Travile" /></div>
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <div className="box-banner-tour-4"><img src="/assets/imgs/page/tour-detail/banner-detail-3.png" alt="Travile" /></div>
                                            </SwiperSlide>
                                    ...
                                    <div className="swiper-button-prev swiper-button-prev-style-1 swiper-button-prev-center">
                                    ...
                                    <div className="swiper-button-next swiper-button-next-style-1 swiper-button-next-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 16 16" >
                            ...
                            <div className="row">
                                <div className="col-lg-8">
                                    ...
                                    <div className="box-collapse-expand">
                                        ...
                                        <div className="group-collapse-expand">
                                            <button className="btn btn-collapse" type="button" data-bs-toggle="collapse" data-bs-target="#collapseIncluded" aria-expanded="false" aria-controls="collapseIncluded">
                                        ...
                                        <div className="group-collapse-expand">
                                            <button className="btn btn-collapse" type="button" data-bs-toggle="collapse" data-bs-target="#collapseDuration" aria-expanded="false" aria-controls="collapseDuration">
                                                <h6>Duration</h6>
                                                <svg width={12} height={7} viewBox="0 0 12 7" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 1L6 6L11 1" stroke="" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
                                                </svg>
